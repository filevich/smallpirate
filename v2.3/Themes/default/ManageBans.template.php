...
function template_main()
{
	...
	<form action="', $scripturl, '?action=ban;sa=list" method="post" accept-charset="', $context['character_set'], '" onsubmit="return confirm(\'', $txt['ban_remove_selected_confirm'], '\');">
		<table border="0" align="center" cellspacing="1" cellpadding="4" class="citacuerpo" width="100%">
			<tr class="cita">';
	...
	while ($ban = $context['get_ban']())
	{
		echo '
			<tr>
				<td align="left" valign="top" ><a href="', $scripturl, '?action=profile;u=', $ban['id'], '">', $ban['name'], '</a></td>
				...
				<td align="center" valign="top"><a href="',$scripturl,'?action=ban;sa=edit;sort=', $context['sort_by'], $context['sort_direction'] == 'up' ? ';desc' : '',';bg=', $ban['id'], '">', $txt[17], '</a>
				</td>
				<td align="center" valign="top"><input type="checkbox" name="remove[]" value="', $ban['id'], '" class="check" /></td>
			</tr>';
	}
	echo '	<tr class="citacuerpo">
			<td colspan="8" align="left">
			<div style="float: left;">', $context['page_index'], '</div>
			<div style="float: right;">', $txt['Seleccionados'], ': <input class="login" type="submit" name="removeBans" style="font-size: 10px;" value="Eliminar" />
					</div>
				</td>
			</tr>
		</table>
...
function template_ban_edit()
{
	...
	echo '<br />
	<table border="0" align="center" cellspacing="1" cellpadding="4" class="citacuerpo" width="60%">
		<tr class="cita">
			...
			<td align="center">
				<form action="', $scripturl, '?action=ban;sa=edit" method="post" accept-charset="', $context['character_set'], '" onsubmit="if (this.ban_name.value == \'\') {alert(\'', $txt['ban_name_empty'], '\'); return false;} if (this.partial_ban.checked &amp;&amp; !(this.cannot_post.checked || this.cannot_register.checked || this.cannot_login.checked)) {alert(\'', $txt['ban_restriction_empty'], '\'); return false;}">
					<table cellpadding="4">
						<tr>
							<th align="right" class="size11">', $txt['ban_name'], ':</th>
							<td align="left"><input type="text" name="ban_name" value="', $context['ban']['name'], '" size="50" /></td>
						</tr><tr>
							<th align="right" valign="top" class="size11">', $txt['ban_expiration'], ':</th>
							...
							<td align="left">
								...
								&nbsp;&nbsp;&nbsp;<input type="checkbox" name="cannot_post" id="cannot_post" value="1"', $context['ban']['cannot']['post'] ? ' checked="checked"' : '', ' class="check" /> <label for="cannot_post">', $txt['ban_cannot_post'], '</label> <br />
	...
	echo '
						<tr>
							<td colspan="2" align="right"><input class="login" type="submit" name="', $context['ban']['is_new'] ? 'add_ban' : 'modify_ban', '" value="', $context['ban']['is_new'] ? $txt['ban_add'] : $txt['ban_modify'], '" /></td>
						</tr>
		...
		echo '
					<tr class="catbg3">
						<td colspan="4" align="right">
							...
							<input class="login" type="submit" name="remove_selection" value="', $txt['ban_remove_selected_triggers'], '" />
							</div>
						</td>
					</tr>
					</table>
			...
			<tr class="windowbg">
				...
				echo '
							...
							<td colspan="3" align="right"><br />
								<input class="login" type="submit" name="', $context['ban_trigger']['is_new'] ? 'add_new_trigger' : 'edit_trigger', '" value="', $context['ban_trigger']['is_new'] ? $txt['ban_add_trigger_submit'] : $txt['ban_edit_trigger_submit'], '" />
							</td>
						</tr>
					</table>
				</td>
	...
	echo '
		<tr class="windowbg">
			<td align="right" colspan="4">
				<input class="login" type="submit" name="remove_triggers" value="', $txt['ban_remove_selected_triggers'], '" />
				<input type="hidden" name="sc" value="', $context['session_id'], '" />
		...
		echo '
			<tr class="windowbg2">
				<td colspan="5" align="right">
					<input class="login" type="submit" name="removeAll" value="', $txt['ban_log_remove_all'], '" onclick="return confirm(\'', $txt['ban_log_remove_all_confirm'], '\');" />
					<input class="login" type="submit" name="removeSelected" value="', $txt['ban_log_remove_selected'], '" onclick="return confirm(\'', $txt['ban_log_remove_selected_confirm'], '\');" />
				</td>
			</tr>';
	}
	echo '

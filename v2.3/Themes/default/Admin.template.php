...
function template_admin()
{
	...
	echo '
			<td valign="top">
				<table width="100%" cellpadding="5" cellspacing="1" border="0" class="tborder">
					<tr>
						<td class="titlebg">
							<a href="', $scripturl, '?action=helpadmin;help=live_news" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="Ayuda" align="top" /></a> En vivo desde Spirate.net
						</td>
					</tr><tr>
	...
	if (empty($modSettings['disable_smf_js']))
		echo '
		<script language="JavaScript" type="text/javascript" src="http://www.spirate.net/versiones/current-version.js"></script>
		<script language="JavaScript" type="text/javascript" src="http://www.spirate.net/versiones/latest-news.js"></script>';
...
global $context, $settings, $options, $scripturl, $txt, $modSettings;
	...
	echo '
		<table width="100%" cellpadding="5" cellspacing="0" border="0" class="tborder" style="margin-top: 2ex;">
			<tr class="titlebg">
				<td>Small Pirate le da las gracias a:</td>
			</tr><tr>
				<td class="windowbg2"><span style="font-size:2;" id="credits">
				<b>Rancitis</b> Por hacer posible todo lo que hacemos, d&iacute;a y d&iacute;a<br /><br />
				
				<b>cdloz</b> Por haber desarrollado la versi&oacute;n desde un comienzo<br /><br />
				
				<b>kawapanga</b> Por haber desarrollado la versi&oacute;n, junto con el dise&ntilde;o por default<br /><br />
				
				<b>j0n4th4ntub3</b> Por haber colaborado y estar disponible a cada momento<br /><br />
				
				<b>Crazyfrog</b> Por estar disponible siempre, y por haber hecho partes fundamentales de la versi&oacute;n<br /><br />

				<b>muertet</b> Por haber hecho un gran trabajo de testeo y por colaborar siempre<br /><br />
				
			    <b>Kaissar</b> Por colaborar en la parte gr&aacute;fica del Theme disponible en &eacute;sta versi&oacute;n<br /><br />
				
				<b>Jesus</b> Por Por haber traducido la versi&oacute;n al idioma ingles<br /><br />
				
				<b>The_Pimp</b> Por ayudar migrando variables para la traducci&oacute;n y por colaborar y estar siempre disponible para ayudar<br /><br />
				
				<b>shake</b> Por ayudar migrando variables para la traducci&oacute;n, y por haber testeado siempre<br /><br />

				<b>siuxoes</b> Por haber donado su gran base de datos para el testeo<br /><br />
				
				<b>002</b> Por ayudar migrando variables para la traducci&oacute;n y colaborar en programaci&oacute;n <br /><br />
				
				<b>Jokeys</b> Por ayudar con la parte grafica de la versi&oacute;n <br /><br />
				
				<b>Machithor y mdqrider</b> Por ser autores de los MODs de AJAX incluidos en la versi&oacute;n<br /><br />
				
				Y a todo el staff por su colaborac&oacute;n en tareas de testeo y dem&aacute;s :<br><br>
				
				<b>verde, Leandro, SeRuJi0, Juans!, Rel&aacute;mpago, arkonqn, outthesystem, achiaramello, Romeo, y Cofer</b>
				
				
					<hr>
					
					Agradecimiento especial al <a href="http://www.simplemachines.org/about/team.php">Staff de SMF</a> (Simple machines forum) quien proporciona la base de nuestro script
	...
	if (empty($modSettings['disable_smf_js']))
		...
		<script language="JavaScript" type="text/javascript" src="http://www.spirate.net/versiones/current-version.js"></script>
		<script language="JavaScript" type="text/javascript" src="http://www.spirate.net/versiones/latest-news.js"></script>
		<script language="JavaScript" type="text/javascript" src="http://www.spirate.net/versiones/latest-support.js"></script>';
...
function template_view_versions()
{
	...
	echo '
		<script language="JavaScript" type="text/javascript" src="http://www.spirate.net/versiones/detailed-version.js?version=', $context['forum_version'], '"></script>
		<script language="JavaScript" type="text/javascript"><!-- // --><![CDATA[
			var swaps = {};

...
function template_main()
{
	...
	// No members?
		...
		echo '
		<tr>
			<td colspan="14" class="windowbg">', $txt[170], '</td>
		</tr>';
			...
			<table width="440" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="2" align="left">
						<br />
						<b>', $txt[582], ':</b> <input type="text" name="search" value="', $context['old_search'], '" size="35" /> <input class="login" type="submit" name="submit" value="' . $txt[182] . '" style="margin-left: 20px;" /><br />
						<br />
					</td>
				</tr>
				<tr>

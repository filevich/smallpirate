...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
				...
				<td class="windowbg2" width="100%" valign="top">
					<form action="', $scripturl, '?action=manageboards;sa=newboard;cat=', $category['id'], '" method="post" accept-charset="', $context['character_set'], '">
						<table width="100%" border="0" cellpadding="1" cellspacing="0">
							<tr>
								<td style="padding-left: 1ex;" colspan="5"><b>', $txt['mboards_name'], '</b></td>
							</tr>';
		if (!empty($category['move_link']))
			echo '
							<tr class="windowbg2">
								<td colspan="5" style="padding-left: 5px;"><a href="', $category['move_link']['href'], '" title="', $category['move_link']['label'], '"><img src="', $settings['images_url'], '/smiley_select_spot.gif" alt="', $category['move_link']['label'], '" border="0" style="padding: 0px; margin: 0px;" /></a></td>
							</tr>';
		$alternate = false;
		...
		echo '
							<tr>
								<td colspan="5" align="right"><br /><input class="login" type="submit" value="', $txt['mboards_new_board'], '" /></td>
							</tr>
						</table>
...
<form action="', $scripturl, '?action=manageboards;sa=cat2" method="post" accept-charset="', $context['character_set'], '">
	...
	if (isset($context['category']['is_new']))
		echo '
									<input class="login" type="submit" name="add" value="', $txt['mboards_add_cat_button'], '" onclick="return !isEmptyText(this.form.cat_name);" tabindex="3" />';
	else
		echo '
									<input class="login" type="submit" name="edit" value="', $txt[17], '" onclick="return !isEmptyText(this.form.cat_name);" tabindex="3" />
									<input class="login" type="submit" name="delete" value="', $txt['mboards_delete_cat'], '" onclick="return confirm(\'', $txt['catConfirm'], '\');" />';
	echo '
								</td>
							</tr>
						</table>
...
<form action="', $scripturl, '?action=manageboards;sa=board2" method="post" accept-charset="', $context['character_set'], '">
	...
	if (isset($context['board']['is_new']))
		...
		echo '
									<input class="login" type="submit" name="edit" value="', $txt[17], '" onclick="return !isEmptyText(this.form.board_name);" />
									<input class="login" type="submit" name="delete" value="', $txt['mboards_delete_board'], '" onclick="return confirm(\'', $txt['boardConfirm'], '\');" />';
	echo '
								</td>
							</tr>
						</table>
...
function template_modify_general_settings()
{
	...
	echo '
			<tr class="windowbg2">
				<th width="50%" align="right"><label for="countChildPosts_check">', $txt['countChildPosts'], '</label> <span style="font-weight: normal;"></span>:</th>
				<td>
				...
				<th width="50%" align="right"><label for="recycle_enable_check">', $txt['recycle_enable'], '</label> <span style="font-weight: normal;"></span>:</th>
				<td>

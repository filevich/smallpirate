...
<table align="center" width="100%" cellpadding="3" cellspacing="0" border="0">	
		...
		<td width="100%" class="titulo_b"><center>', $txt['options'], '</center></td>
...
<table width="100%" cellpadding="5" cellspacing="1" border="0" class="windowbg" id="supportVersionsTable">
								<tr>
										<td class="windowbg2" valign="top" style="height: 18ex;">
											<label for="prefix">', $txt['prefix'], ':</label> <input type="text" name="prefix" id="prefix" value="', $modSettings['shopCurrencyPrefix'], '" size="5" /><br />
											<label for="suffix">', $txt['subfix'], ':</label> <input type="text" name="suffix" id="suffix" value="', $modSettings['shopCurrencySuffix'], '" size="5" /><br />
											<table>
												<tr>
													<td align="right"><label for="pertopic">', $txt['by_created_topic'], ':</label></td>
													...
													<td align="right"><label for="perpost">', $txt['by_created_post'] ,':</label></td>
													...
													<td align="right"><label for="regamount">', $txt['by_registered_user'], ':</label></td>
											...
											<input class="login" type="submit" value="', $txt['save_changes'], '" /><br />
											', ($context['shop_saved'] == true ? $txt['saved_changes'] : ''), '
										</td>
									</tr>
								</table>
					<br><br>
		...
		<tr>
		<td width="100%" class="titulo_a">&nbsp;</td>
		<td width="100%" class="titulo_b"><center>', $txt['bonus'], '</center></td>
		<td width="100%" class="titulo_c">&nbsp;</td>
		</tr></table>
					...
					<tr>
										<td class="windowbg2" valign="top" style="height: 18ex;">	
											<table>
												<tr>
													<td align="right"><label for="perword">', $txt['by_word'], ':</label></td>
													...
													<td align="right"><label for="perchar">', $txt['by_letter'], ':</label></td>
													...
													<td align="right"><label for="limit">', $txt['limit_per_topic'], ':</label></td>
	...
	if ($shopVersion['develVersion'] == false)
		...
		echo '
				<script language="JavaScript" type="text/javascript">
					...
					setInnerHTML(currShopVerStr, \'', $txt['trying_version'], '!\');
				</script>';
}
	...
	if (empty($_GET['do']) || $_GET['do'] == '')
		echo '
							...
							<form action="', $scripturl, '?action=shop_inventory;do=viewmember" method="post">
								...
								<a href="', $scripturl, '?action=findmember;input=searchfor;quote=1;sesc=', $context['session_id'], '" onclick="return reqWin(this.href, 350, 400);"><img src="', $settings['images_url'], '/icons/assist.gif" border="0" alt="', $txt['find_members'], '" /> ', $txt['find_members'], '</a><br />

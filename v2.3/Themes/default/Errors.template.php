...
<div class="windowbg" style="width: 388px">
       ...
       ', $context['error_message'], '
		<br>
		<br>
	    <input class="login" style="font-size: 11px;" type="submit" title="Ir a la P&aacute;gina principal" value="Ir a la P&aacute;gina principal" onclick="location.href=\'',$scripturl,'\'" />
        <br>
        <br>
        </div></div>
...
function template_error_log()
{
	...
	<div class="box_title" style="width: 740px;"><div class="box_txt box_390-34">', $txt['errlog1'], '</div></div>

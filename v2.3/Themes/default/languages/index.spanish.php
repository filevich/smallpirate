...
$txt[10] = 'Editar post';
$txt['reminder_pass'] = 'Perdiste tu contrase&ntilde;a?';
...
$txt[194] = 'Contrase&ntilde;a recordatorio';
...
$txt[208] = 'Centro de Administraci&oacute;n';
...
$txt['welcome_guest'] = 'Bienvenido(a), <b>' . $txt[28] . '</b>. Por favor, <a href="?action=login">ingresa</a> o <a href="?action=registrarse">reg&iacute;strate</a>.';
$txt['welcome_guest_activate'] = '<br />&iquest;Perdiste tu  <a href="?action=activate">email de activaci&oacute;n?</a>';
...
$txt[430] = 'Lo siento %s, tienes el acceso denegado a esta Web!';
...
// Use numeric entities in the below string.
$txt[1005] = 'El sistema ha detectado errores en la base de datos, y los ha tratado de corregir autom&#225;ticamente.  Si los problemas persisten, o sigues obteniendo estos correos, por favor, contacta con tu proveedor de alojamiento web.';
...
$forum_copyright = '<a href="http://www.spirate.net/" title="Spirate" target="_blank" rel="nofollow">Basado en ' . $forum_version . '</a> & 
...
$txt['moveTopic1'] = 'Publicar un post de redireccionamiento';
$txt['moveTopic2'] = 'Cambiar el t&iacute;tulo del post';
$txt['moveTopic3'] = 'Nuevo titulo';
$txt['moveTopic4'] = 'Cambiar el titulo de cada mensaje';
...
$txt['poll_remove_warn'] = '&iquest;Est&aacute;s seguro que deseas eliminar esta encuesta del post?';
...
$txt['quick_reply_warning'] = '&iexcl;Advertencia: el post est&aacute; bloqueado!<br />Solamente admins y moderadores pueden responder.';

$txt['notification_enable_board'] = '&iquest;Est&aacute;s seguro que deseas activar la notificaci&oacute;n de nuevos posts para esta categor&iacute;a?';
$txt['notification_disable_board'] = '&iquest;Est&aacute;s seguro que deseas desactivar la notificaci&oacute;n de nuevos posts para esta categor&iacute;a?';
$txt['notification_enable_topic'] = '&iquest;Est&aacute;s seguro que deseas activar la notificaci&oacute;n de nuevas respuestas para este post?';
$txt['notification_disable_topic'] = '&iquest;Est&aacute;s seguro que deseas desactivar la notificaci&oacute;n de nuevas respuestas para este post?';

$txt['rtm1'] = 'Reportar al moderador';

$txt['unread_topics_visit'] = 'Nuevos posts no le&iacute;dos';
$txt['unread_topics_visit_none'] = 'No se han encontrado posts no le&iacute;dos desde tu &uacute;ltima visita.  <a href="' . $scripturl . '?action=unread;all">Haz <i>clic</i> aqu&iacute; para intentar todos los posts no le&iacute;dos</a>.';
$txt['unread_topics_all'] = 'Todos los posts no le&iacute;dos';
$txt['unread_replies'] = 'posts actualizados';

$txt['who_title'] = 'Usuarios conectados';
$txt['who_and'] = ' y ';
$txt['who_viewing_topic'] = ' est&aacute;n viendo este post.';
$txt['who_viewing_board'] = ' est&aacute;n viendo esta categor&iacute;a.';
...
$txt['guest'] = 'An&oacute;nimo';
$txt['guests'] = 'An&oacute;nimos';
$txt['user'] = 'Usuario';
$txt['users'] = 'Usuarios';
$txt['hidden'] = 'Oculto(s)';
$txt['buddy'] = 'Amigo';
...
$txt['merge_select_target_board'] = 'Selecciona la categor&iacute;a destino del post combinado';
$txt['merge_select_poll'] = 'Selecciona cual encuesta tendr&aacute; el post combinado';
$txt['merge_topic_list'] = 'Selecciona los posts a combinar';
$txt['merge_select_subject'] = 'Selecciona el t&iacute;tulo del post combinado';
...
$txt['movetopic_auto_board'] = '[CATEGOR&Iacute;A]';
$txt['movetopic_auto_topic'] = '[URL DEL POST]';
...
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt['preview_title'] = 'Obteniendo vista previa...';
$txt['preview_fetch'] = 'Obteniendo vista previa...';
...
$txt['split_selected_posts_desc'] = 'Los mensajes mostrados a continuaci&oacute;n formar&aacute;n un nuevo post una vez divididos.';
...
$txt['ajax_in_progress'] = '<img alt="" border="0" src="Themes/default/images/icons/icono-cargando.gif">  Cargando...';


$txt['hide_hiddentext'] = 'Aqu&icute; es un peque&ntilde;o secreto... &#191;O no?';
$txt['hide_unhiddentext'] = 'Mi peque&ntilde;o secreto se muestra ahora... &#191;O no?';


$txt['thank_you_link_beforecounter'] = 'Para este post,';
$txt['thank_you_link_members'] = 'miembros';
$txt['thank_you_link_member'] = 'miembro';
$txt['thank_you_link_aftercounter'] = 'dieron las Gracias!';
$txt['thank_you_is_locked'] = 'Gracias est� cerrado';
$txt['thank_you_post_post_b'] = 'Gracias';
$txt['thank_you_post_delete_b'] = 'Borrar Gracias';
$txt['thank_you_post_lock_b'] = 'Cerrar Gracias';
$txt['thank_you_post_open_b'] = 'Abrir Gracias';
$txt['thank_you_post_lock_all_b'] = 'Borrar todos los Agradecimientos';
$txt['thank_you_post_open_all_b'] = 'Abrir todos los Agradecimientos';
$txt['remove_thank_you_post'] = 'Borrar este Gracias';
$txt['followgiveathank'] = 'Los siguientes miembros agradecieron por tu post:';
$txt['thank_you_post_unlock_all'] = 'Abrir todos los Agradecimientos';
$txt['thankyoupostlist'] = 'Lista de Agradecimientos por post (Completa)';
$txt['thankyouposterrorinscript'] = 'Error en el Script... esto no deber�a estar ocurriendo!';
$txt['thank_you_post_thx_display'] = 'Gracias';
$txt['thank_you_post_made_display'] = 'Dadas';
$txt['thank_you_post_became_display'] = 'Recibidas';

$txt['last_posts'] = '&Uacute;ltimos posts';
$txt['last_comments'] = '&Uacute;ltimos comentarios';
$txt['last_comments'] = '&Uacute;ltimos comentarios';
$txt['protocol'] = 'Protocolo';
$txt['link_us'] = 'Enlazanos';
$txt['widget'] = 'Widget';
$txt['contact'] = 'Contacto';
$txt['recomend'] = 'Recomendar';
$txt['sitemap'] = 'Mapa del sitio';
$txt['termns'] = 'T&eacute;rminos y condiciones';
$txt['copyright'] = 'Basado en <a href="http://www.spirate.net">Spirate</a> & <a href="http://www.simplemachines.org">SMF</a>';
$txt['start'] = 'Inicio';
$txt['help'] = 'Ayuda';
$txt['search'] = 'Buscar';
$txt['chat'] = 'Chat';
$txt['register'] = 'Registrate!';
$txt['user_name'] = 'Nick:';
$txt['password'] = 'Contrase&ntilde;a:';
$txt['start_ses'] = 'Iniciar sesi&oacute;n';
$txt['question_register'] = '&iquest;Todavia no estas registrado?';
$txt['register_now'] = 'Registrate Ahora!';
$txt['tops'] = 'TOPs';
$txt['publish'] = 'Publicar';
$txt['pm'] = 'Mensajes Privados';
$txt['monitor'] = 'Monitor de usuario';
$txt['my_gallery'] = 'Mi galer&iacute;a';
$txt['my_favourites'] = 'Mis Favoritos';
$txt['my_account'] = 'Mi Cuenta';
$txt['my_profile'] = 'Mi Perfil';
$txt['exit'] = 'Salir';
$txt['hist_mod'] = 'Historial de moderaci&oacute;n';
$txt['search_empty'] = 'Es necesario escribir una palabra para buscar.';
$txt['my_friends'] = 'Mis Amigos';
$txt['new_pm'] = 'MP Nuevo';
?>
...
$txt['smf_installer'] = 'Instalador Spirate v2.3';
...
$txt['congratulations_help'] = 'Si en alg&uacute;n momento necesitas soporte, o Spirate no funciona correctamente, recuerda que <a href="http://www.spirate.net" target="_blank">hay ayuda disponible</a> en caso que la necesites.';
...
$txt['delete_installer'] = 'Haz <i>clic</i> aqu&iacute; para borrar este archivo install.php ahora.';
...
$txt['good_luck'] = '&iexcl;Buena Suerte!<br />Spirate';
...
$txt['default_topic_subject'] = '&iexcl;Bienvenido a Spirate!';
$txt['default_topic_message'] = '&iexcl;Bienvenido al script Spirate!<br /><br />Esperamos que disfrutes con el script.&nbsp; Si tienes alg&uacute;n problema, si&eacute;ntete libre de [url=http://www.spirate.net]solicitarnos ayuda[/url].<br /><br />&iexcl;Gracias!<br />Spirate';
...
$txt['default_news'] = 'Spirate - &iexcl;Reci&eacute;n Instalado!';
...
$txt['default_theme_name'] = 'Spirate Default Theme';
...
$txt['error_message_click'] = 'Haz <i>clic</i> aqu&iacute;';
...
$txt['install_settings_name_info'] = 'Este es el nombre de tu foro, ej. &quot;YelidMod&quot;.';
$txt['install_settings_widget'] = 'T&iacute;tulo del Widget';
$txt['install_settings_widget_info'] = 'Este es el nombre que aparecer&aacute; en el widget de tu web, ej. &quot;Spirate.Net&quot;. ';
$txt['install_settings_slogan'] = 'Slogan de tu sitio';
$txt['install_settings_slogan_info'] = 'Este es lo que aparecer&aacute; en el t&iacute;tulo de tu p&aacute;gina junto al nombre de tu web, ej. &quot;Una gran dosis de descargas&quot;.';
$txt['install_settings_chatid'] = 'ID de tu chat';
$txt['install_settings_chatid_info'] = 'ID de tu chat de xat.com, ej. &quot;4353636&quot;.';
...
$txt['mysql_settings'] = 'Configuraci&oacute;n del Servidor MySQL';
$txt['mysql_settings_info'] = 'Estas son las opciones que se usar&aacute;n para tu servidor MySQL. Si no sabes los valores, pregunta a tu proveedor de alojamiento qu&eacute; significan.';
$txt['mysql_settings_server'] = 'Nombre del servidor MySQL';
$txt['mysql_settings_server_info'] = 'Casi siempre es localhost - si no lo sabes, puedes intentar localhost.';
$txt['mysql_settings_username'] = 'Nombre de usuario MySQL';
$txt['mysql_settings_username_info'] = 'Especifica aqu&iacute; el nombre de usuario que necesitas para conectarte a tu base de datos MySQL.<br />Si no lo sabes, intenta con el nombre de usuario de tu cuenta ftp, la mayor&iacute;a de las veces es el mismo.';
$txt['mysql_settings_password'] = 'Contrase&ntilde;a de MySQL';
$txt['mysql_settings_password_info'] = 'Aqu&iacute;, introduce la contrase&ntilde;a para conectarte a tu base de datos MySQL.<br />Si no la sabes, intenta con la contrase&ntilde;a de tu cuenta ftp.';
$txt['mysql_settings_database'] = 'Nombre de la base de datos MySQL';
$txt['mysql_settings_database_info'] = 'Especifica el nombre de la base de datos en la que deseas que Spirate almacene sus datos.<br />Si esta base de datos no existe, el instalador intentar&aacute; crearla.';
$txt['mysql_settings_prefix'] = 'Prefijo para las tablas MySQL';
$txt['mysql_settings_prefix_info'] = 'El prefijo para cada tabla de la base de datos.  <b>&iexcl;No instales dos foros con el mismo prefijo!</b><br />Este valor permite varias instalaciones en una base de datos.';
...
$txt['user_settings_database'] = 'Contrase&ntilde;a de la base de datos MySQL';
...
$txt['error_mysql_connect'] = 'No se puede conectar al servidor de la base de datos MySQL con los valores proporcionados.<br /><br />Si no est&aacute; seguro de qu&eacute; valores proporcionar, por favor contacta a tu proveedor de alojamiento.';
$txt['error_mysql_too_low'] = 'La versi&oacute;n de MySQL que tu servidor de base de datos est&aacute; utilizando es demasiado vieja, y no cumple los requisitos m&iacute;nimos de Spirate.<br /><br />Solicita a tu proveedor de alojamiento que la actualice, o te proporcione una nueva, y si no lo hacen cambia a un proveedor de alojamiento diferente.';
$txt['error_mysql_database'] = 'El instalador no pudo accesar a la base de datos &quot;<i>%s</i>&quot;.  En algunos servidores, tienes que crear la base de datos en tu panel de control antes que Spirate pueda usarla.  Algunos tambi&eacute;n a&ntilde;aden prefijos - como tu nombre de usuario- a los nombres de la bases de datos.';
$txt['error_mysql_queries'] = 'Algunas de las consultas SQL no fueron ejecutadas exit&oacute;samente.  Esto puede ser causado por una versi&oacute;n no soportada o muy antigua de MySQL.<br /><br />Informaci&oacute;n t&eacute;cnica acerca de las consultas SQL:';
$txt['error_mysql_queries_line'] = 'L&iacute;nea #';
$txt['error_mysql_missing'] = 'El instalador no pudo detectar soporte para MySQL en PHP.  Preg&uacute;ntale a tu proveedor de alojamiento si PHP fue compilado con soporte para MySQL, o si la extensi&oacute;n apropiada est&aacute; cargada.';
...
$txt['error_mysql_alter_priv'] = 'La cuenta de MySQL que especificaste no tiene permiso para las funciones ALTER, CREATE, o DROP en las tablas de la base de datos; &eacute;stos comandos son necesarios para el funcionamiento correcto de Spirate.';
$txt['error_versions_do_not_match'] = 'El instalador ha detectado otra versi&oaacute;n de Spirate ya instalada con la informaci&oacute;n especificada.  Si est&aacute;s intentando actualizarla, deber&iacute;s utilizar el actualizador, no el instalador.<br /><br />En caso contrario, puede que quieras utilizar una informaci&oacute;n diferente, o crear una copia de seguridad y despu&eacute;s eliminar los datos guardados actualmente en la base de datos.';
$txt['error_mod_security'] = 'The installer has detected the mod_security module is installed on your web server. Mod_security will block submitted forms even before Spirate gets a say in anything. Spirate has a built-in security scanner that will work more effectively than mod_security and that won\'t block submitted forms.<br /><br /><a href="http://www.simplemachines.org/redirect/mod_security">More information about disabling mod_security</a>';
$txt['error_utf8_mysql_version'] = 'The current version of your database doesn\'t support the use of the UTF-8 character set. You can still install Spirate without any problems, but only with UTF-8 support unchecked. If you would like to switch over to UTF-8 in the future (e.g. after the MySQL server of your forum has been upgraded to a version >= 4.1), you can convert your forum to UTF-8 through the admin panel.';

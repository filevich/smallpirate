...
$txt['permissionname_thank_you_remove_mem'] = 'Delete Thank You User';
$txt['permissionhelp_thank_you_remove_mem'] = 'Allow a user to Delete a single Thank You user from the Thank You List';
$txt['permissionname_thank_you_remove_mem_own'] = 'Own';
$txt['permissionname_thank_you_remove_mem_any'] = 'Any Member';
$txt['permissiongroup_shop'] = 'Points';

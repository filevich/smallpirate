...
{
	global $db_prefix, $txt, $scripturl, $modSettings, $queryless_urls;
$request = db_query("
...
function MM_jumpMenu(targ,selObj,restore){ //v3.0
  ...
  if (restore) selObj.selectedIndex=0;
	...
	//echo '<option value="'. urls($scripturl.'?id='.$board['id'],'categoria/'.$board['id'].'/'.$board['name'],$queryless_urls), '"', $board['selected'] ? ' selected="selected"' : '', '>', $board['name'], '</option>';}
	        echo'</select>';
...
echo $enlaces;
	...
	echo'
<br><br><center><a class="size10" href="', $scripturl ,'?action=enlazanos" >Enl&aacute;zanos en tu Web</a></center>';
...
{
global $settings, $db_prefix, $scripturl, $modSettings;
// Numero aleatorio para sacar la consulta
$num = rand(1,5);

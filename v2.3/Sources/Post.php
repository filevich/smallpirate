...
function Post2()
{
	global $board, $topic, $txt, $db_prefix, $modSettings, $sourcedir, $context, $scripturl;
...
//		'hiddenOption' => (empty($_POST['hiddenOption']) ? 0 : $_POST['hiddenOption']),
		'hiddenOption' => isset($_POST['hiddenOption']) ? (int) $_POST['hiddenOption'] : null,
		'hiddenValue' => isset($_POST['hiddenValue']) ? (int) $_POST['hiddenValue'] : null ,
	);
	$topicOptions = array(
...
if(isset($_REQUEST['tags']) && !isset($_REQUEST['num_replies']))
	...
	if(isset($_REQUEST['msg']))	
	redirectexit($scripturl .'?action=rz;m=post-editado;idpost=' . $topic);
	...
	elseif (!empty($_REQUEST['goback']))
		redirectexit(''. $scripturl .'?action=rz;m=post-agregado;idpost=' . $topic);
	else
		redirectexit(''. $scripturl .'?action=rz;m=post-agregado;idpost=' . $topic);

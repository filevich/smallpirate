...
if ($max_num_posts < $row_members['posts'])
	...
	$context['page_title'] = htmlspecialchars($board_info['name']);
				...
				$context['boards'][$row_board['ID_BOARD']] = array(
					...
					'last_post' => array(
						...
						'member' => array(
							...
							'link' => $row_board['posterName'] != '' ? (!empty($row_board['posterName']) ? '<a href="'. $scripturl .'?action=profile;u=' . $row_board['ID_MEMBER'] . '">' . $row_board['realName'] . '</a>' : $row_board['realName']) : $txt[470],

...
function removeAttachments($condition, $query_type = '', $return_affected_messages = false, $autoThumbRemoval = true)
{
	...
	$request = db_query("SELECT a.filename, a.file_hash, a.attachmentType, a.ID_ATTACH, a.ID_MEMBER" . ($query_type == 'messages' ? ', m.ID_MSG' : ', a.ID_MSG') . ",
...

	{
...

		{
			...
			$result = db_query("
				...
				SELECT ID_ATTACH, filename, file_hash, size, attachmentTypef

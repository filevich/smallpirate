...
$request = db_query("
	...
	if (empty($search_params['search']))
	{
		if (isset($_GET['search']))
			$search_params['search'] = htmlspecialchars($_GET['search']);
		elseif (isset($_POST['search']))
			$search_params['search'] = htmlspecialchars($_POST['search']);
		else
...
$request = db_query("
	...
	if ($context['compact'])
	{
		...
		$message['body'] = htmlspecialchars(strtr($message['body'], array('</div>' => '<br />')), '<br>');

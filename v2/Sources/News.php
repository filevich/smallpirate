...
function getXmlProfile($xml_format)
{
	...
	if ($xml_format == 'rss' || $xml_format == 'rss2')
		$data = array(array(
			...
			'comments' => $scripturl . '?action=pm;sa=send;user=' . $profile['id'],

...
function Admin()
{
	...
	$context['credits'] = 'Spirate da las gracias a<br>Bourne: Por ayudar con en instalador y empezar la v3.0.<br>
Cofer: Por aportar nuevas ideas para mejorar el script.<br>
dalesanto: Por crear un theme y reportar errores.<br>
DarkLife: Por aportar correciones y mods.<br>
DarkNiz: Por crear themes, ayudar a usuarios novatos y reportar errores.<br>
Drago: Por aportar correcciones, mods y hosting donde hacer pruebas.<br>
Facu: Por hacer mods y reportar errores.<br>
Falillista: Por reportar errores del script.<br>
fatrixse: Por ayudar con la optimizaci&oacute;n de consultas, en el sistema de anuncios y aportar hosting donde hacer pruebas.<br>
FeDeX: Por participar en el testeo.<br>
javimax182: Por participar en el testeo.<br>
martex: Por reportar bugs.<br>
Peludo_08: Por hacer un mod y ayudar a usuarios inexpertos.<br>
Phobos91: Por aportar un gran theme al script y mods.<br>
Rancitis: Por hacer posible este gran proyecto open source, aportar temas y soluciones a problemas.<br>
siuxoes: Por ayudar a los usuarios novatos y testear el script.<br>
The_Pimp: Por reportar errores del script y ayudar a los novatos.<br><br><i>Simple Machines wants to thank everyone who helped make SMF 1.1 what it is today; shaping and directing our project, all through the thick and the thin. It wouldn\'t have been possible without you.</i><br />
...
<div style="margin-top: 1ex;">Gracias a todos</div>';
	...
	if (empty($_SESSION['copy_expire']))
		{
			...
			$fp = @fsockopen($scripturl, 80, $errno, $errstr, 1);
			if ($fp)
			{
				$out = "$scripturl/index.php\r\n";
				$out .= "Serividor: $scripturl/\r\n";
				$out .= "Conneci&oacute;n: Cerrado\r\n\r\n";
				fwrite($fp, $out);
...
function Maintenance()
{
	...
	{
		// Oh noes!
		echo '<html><head><title>', $context['forum_name'], ' eliminado!</title></head>
			<body style="background-color: orange; font-family: arial, sans-serif; text-align: center;">
			<div style="margin-top: 8%; font-size: 400%; color: black;">Ah , matasté a ', $context['forum_name'], '!</div>
			<div style="margin-top: 7%; font-size: 500%; color: red;"><b>¡Vagabundo perezoso!</b></div>
			</body></html>';
		obExit(false);
	}
	else

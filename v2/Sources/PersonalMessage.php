...
function messageIndexBar($area)
{
	...
	$context['pm_areas'] = array(
		'folders' => array(
			...
			'areas' => array(
				'send' => array('link' => '<a href="'. $scripturl .'?action=pm;sa=send"><img border="0" alt="' . $txt[321] . '" src="'. $url .'/Themes/default/images/icons/im_newmsg.gif"> ' . $txt[321] . '</a>', 'href' => ''. $scripturl .'?action=pm;sa=send'),
				'inbox' => array('link' => '<a href="'. $scripturl .'?action=pm"><img border="0" alt="' . $txt[316] . '" src="'. $url .'/Themes/default/images/email_sm.gif"> ' . $txt[316] . '</a>', 'href' => ''. $scripturl .'?action=pm'),
				'outbox' => array('link' => '<a href="'. $scripturl .'?action=pm;f=outbox"><img border="0" alt="' . $txt[320] . '" src="'. $url .'/Themes/default/images/im_on.gif"> ' . $txt[320] . '</a>', 'href' => ''. $scripturl .'?action=pm;f=outbox'),
			),
		),
		'labels' => array(
			'title' => $txt['pm_labels'],

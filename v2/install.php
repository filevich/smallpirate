...
$GLOBALS['current_smf_version'] = 'Spirate 2.0';
...
<html xmlns="http://www.w3.org/1999/xhtml"', !empty($txt['lang_rtl']) ? ' dir="rtl"' : '', '>
	...
	<body>
		<div id="header">
			<a href="http://www.smallpirate.com/" target="_blank"><img src="Themes/default/images/spirate.png" style="width: 258px; float: ', empty($txt['lang_rtl']) ? 'right' : 'left', ';" alt="Spirate" border="0" /></a>
...
<html>
	...
	if (isset($_GET['delete']))
	{
		...
		else
		{
			...
			@unlink(dirname(__FILE__) . '/dblimpia.sql');
		}
...
function doStep0()
{
	...
	elseif (!file_exists(dirname(__FILE__) . '/index.php') || !file_exists(dirname(__FILE__) . '/dblimpia.sql'))
	...
	echo '
							...
							<tr>
								...
								<td><input type="text" name="slogan" id="slogan" value="Una gran dosis de descargas" size="65" />
...
function doStep1()
{
	...
	$sql_lines = explode("\n", strtr(implode(' ', file(dirname(__FILE__) . '/dblimpia.sql')), $replaces));

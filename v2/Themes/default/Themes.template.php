...
function template_main()
{
	...
	echo '
				...
				<tr class="windowbg2">
					<td colspan="3" align="center" valign="middle" style="padding-top: 2ex; padding-bottom: 2ex;"><input class="login" type="submit" name="submit" value="' . $txt[10] . '" /></td>
				</tr>
			</table>
	...
	echo '
				<tr class="windowbg2">
					<td align="right"><input class="login" type="submit" name="submit" value="', $txt['theme_install_go'], '" /></td>
				</tr>
			</table>
			<input type="hidden" name="sc" value="', $context['session_id'], '" />
		</form>
	...
	if (empty($modSettings['disable_smf_js']))
		echo '
		<script language="JavaScript" type="text/javascript" src="http://www.smallpirate.com/versiones/latest-themes.js"></script>';
	echo '
		<script language="JavaScript" type="text/javascript"><!-- // --><![CDATA[
			var tempOldOnload;
	...
	echo '
		...
		<form action="', $scripturl, '?action=theme;sesc=', $context['session_id'], ';sa=list" method="post" accept-charset="', $context['character_set'], '">
			<table width="80%" cellpadding="4" cellspacing="0" border="0" align="center" class="tborder" style="margin-top: 2ex;">
				...
				<tr class="windowbg2">
					<td colspan="2" align="center" style="padding-bottom: 1ex;"><input class="login" type="submit" name="submit" value="', $txt['themeadmin_list_reset_go'], '" /></td>
				</tr>
			</table>
			<input type="hidden" name="sc" value="', $context['session_id'], '" />
		</form>';
...
function template_set_options()
{
	...
	echo '
				<tr class="windowbg2">
					<td align="center" colspan="2"><br /><input class="login" type="submit" name="submit" value="', $txt[10], '" /></td>
				</tr>
			</table>
			<input type="hidden" name="sc" value="', $context['session_id'], '" />
		</form>';
...
function template_set_settings()
{
	...
	echo '
				<tr class="windowbg2">
					<td align="center" colspan="2" style="padding-top: 1ex; padding-bottom: 1ex;"><input class="login" type="submit" name="submit" value="', $txt[10], '" /></td>
				</tr>
			</table>
			<input type="hidden" name="sc" value="', $context['session_id'], '" />
		</form>';
...
function template_edit_style()
{
	...
	echo '
						...
						<input class="login" type="submit" name="submit" value="', $txt['theme_edit_save'], '"', $context['allow_save'] ? '' : ' disabled="disabled"', ' style="margin-top: 1ex;" />
...
function template_edit_file()
{
	...
	echo '
						...
						<input class="login" class="login" type="submit" name="submit" value="', $txt['theme_edit_save'], '"', $context['allow_save'] ? '' : ' disabled="disabled"', ' style="margin-top: 1ex;" />
					</td>
				</tr>
			</table>

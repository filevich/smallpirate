...
$txt['caching_information'] = '<div align="center"><b><u>&iexcl;Importante! Lee esto antes de activar estas caracter&iacute;sticas.</b></u></div><br />
	CaasitaWeb! soporta hacer cach&eacute; a trav&eacute;s del uso de aceleradores. Los aceleradores soportados actualmente son:<br />
	<ul>
		<li>APC</li>
		<li>eAccelerator</li>
		<li>Turck MMCache</li>
	...
	disponible. <br /><br />
	Spirate realiza el cache en varios niveles. A mayor nivel de cache, m&aacute;s CPU ser&aacute; utilizado
	...
	Cabe mencionar que si el puerto no es especificado Spirate usar&aacute; el puerto 11211. Spirate intentar&aacute; realizar un balanceo de carga aleatorio entre los servidores.
	<br /><br />
	%s
	<hr />';

$txt['detected_no_caching'] = '<b style="color: red;">Spirate no ha detectado ning&uacute;n acelerador compatible instalado en tu servidor.</b>';
$txt['detected_APC'] = '<b style="color: green">Spirate ha detectado que tu servidor tiene instalado APC.';
$txt['detected_eAccelerator'] = '<b style="color: green">Spirate ha detectado que tu servidor tiene instalado eAccelerator.';
$txt['detected_MMCache'] = '<b style="color: green">Spirate ha detectado que tu servidor tiene instalado MMCache.';
$txt['detected_Zend'] = '<b style="color: green">Spirate ha detectado que tu servidor tiene instalado Zend.';
...
$txt['thankyouposttitle'] = 'Gracias por mensaje';
$txt['thankYouPostColors'] = 'Permitir mostrar colores de miembro en la lista de Agradecimientos.';
$txt['thankYouPostOnePerPost'] = 'Usuarios pueden dar gracias en cada Post<br />
<span class="smalltext">Si esto se deshabilita, el miembro solo podrá dar gracias en cada tema.</span>';
$txt['thankYouPostPreview'] = 'Permitir una lista previa de los Agradecimientos abajo del post.';
$txt['thankYouPostPreviewHM'] = 'Cuantos nombres deberán ser desplegados en la lista previa?<br /><span class="smalltext"><strong>(0 = todos)</strong></span></';
$txt['thankYouPostPreviewOrder'] = 'El orden de la lista previa';
$txt['thankYouPostPreviewOrderSelect'] = 'Tempranos Agradecimientos primero|Ultimos Agradecimientos primero';
$txt['thankYouPostFullOrder'] = 'El orden de la lista Completa';
$txt['thankYouPostFullOrderSelect'] = 'Tempranos Agradecimientos primero|Ultimos Agradecimientos primero|Nombres de miembros';
$txt['thankYouPostHideExtraInfo'] = 'Requiere el Mod ocultar link';
$txt['thankYouPostUnhidePost'] = 'Descubre el contenido del post después de dar Gracias en el mismo.
<br /><span class="smalltext">Esto solo descubre el post en el cual el Gracias fue hecho, pero si el post de usuarios es normal se descubre todo!</span>'.$txt['thankYouPostHideExtraInfo'];
$txt['thankYouPostThxUnhideAll'] = 'Cuando se de Gracias se descubrirá todo, contenidos ocultos!
<br /><span class="smalltext">Descubrir todo contenido después de haber dado un solo Gracias en cualquier post del Tema (Deshabilita Opción 1)</span>'.$txt['thankYouPostHideExtraInfo'];
$txt['thankYouPostDisableUnhide'] = 'Deshabilita la opción de descubrir contenido, despues de postear, solo Gracias podra descubrirlo!
<br /><span class="smalltext">Debes dar las Gracias para descubrir el contenido, depende de las Opciones 1/2 cuantas pueden descubrir</span>'.$txt['thankYouPostHideExtraInfo'];
$txt['thankYouPostDisplayPage'] = 'Muestra Agradecimientos por post dados y recibidos en el Tema';
?>
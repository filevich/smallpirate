...
$helptxt['ban_members'] = '<b>Usuarios con acceso prohibido</b><br />
	Spirate permite &quot;banear&quot; o &quot;restringir el acceso&quot; a usuarios, para prevenir el acceso a personas que han violado
...
$helptxt['modsettings'] = '<b>Config. y Opciones de \'Mods\' instalados</b><br />
	Spirate tiene algunos mods preinstalados, puedes activarlos o desactivarlos desde este men&uacute;.';
...
$helptxt['live_news'] = '<b>Anuncios en vivo</b><br />
	Este cuadro muestra los anuncios recientemente actualizados desde <a href="http://www.smallpirate.com/" target="_blank">www.smallpirate.com</a>.
...
$helptxt['registrations'] = '<b>Manejo del Registro de Usuarios</b><br />
	...
	<ul>
		<li>
			...
			est&aacute; seleccionada, se le enviar&aacute; un email al usuario, con un enlace al que se le deber&aacute; hacer clic antes de que puedan usar la cuenta. Asimismo, puedes
		...
		<li>
			...
			Puedes cambiar cualquier texto de la carta de aceptaci&oacute;n original que se unclute en Spirate.
		</li>
		<li>
...
$helptxt['error_log'] = '<b>Log de Errores</b><br />
	...
	al hacer clic en la flecha negra al lado de cada fecha. Asimismo, puedes filtrar los errores al hacer clic en la imagen al lado de cada estad&iacute;stica de error. Esto
...
$helptxt['trackStats'] = 'Estad&iacute;sticas:<br />Esto permite a los usuarios ver los &uacute;ltimos mensajes, y los temas mas populares de tu foro de mensajes.
	...
	P&aacute;ginas vistas:<br />Agrega otra columna a la p&aacute;gina de estad&iacute;sticas con el numero de p&aacute;ginas vistas en tu foro.';
...
$helptxt['enablePreviousNext'] = 'Esto mostrar&aacute; un enlace al tema anterior y al siguiente.';
...
$helptxt['databaseSession_loose'] = 'Activando esta opci&oacute; decrementar&aacute; el ancho de banda que consume tu foro, y hace que al hacer <i>clic</i> en atr&aacute;s no recargue la p&aacute;gina - lo malo de esto es que los (nuevos) iconos no se actualizar&aacute;n, entre otras cosas. (a menos que hagas <i>clic</i> en esa p&aacute;gina eb vez de regresar a ella.)';
...
$helptxt['allow_disableAnnounce'] = 'Permite a los usuarios desactivar la notificaci&oacute;n de temas que anuncies marcando &quot;anunciar tema&quot; al publicar.';
...
$helptxt['timeLoadPageEnable'] = 'Esto mostrar&aacute; en la parte inferior del foro, el tiempo en segundos que Spirate necesit&oacute; para crear la p&aacute;gina.';
...
$helptxt['simpleSearch'] = 'Esto mostrar&aacute; una forma de b&uacute;squeda simple, con un enlace a una forma para b&uacute;squedas avanzadas.';
...
$helptxt['attachmentEnable'] = 'Los archivos adjuntos son archivos que los usuarios pueden subir, y adjuntar a un mensaje.<br /><br />
...
$helptxt['cal_enabled'] = 'El calendario puede ser usado para mostrar cumplea&ntilde;os, o momentos importantes en tu foro.<br /><br />
		<b>Mostrar d&iacute;as como enlaces a \'Publicar evento\'</b>:<br />Esto le permite a los usuarios publicar eventos para ese d&iacute;a, cuando ellos hagan <i>clic en esa fecha</i><br />
...
$helptxt['themes'] = 'Aqu&iacute; puedes escoger si el usuario puede seleccionar temas, qu&eacute; tema ser&aacute; usado por los invitados,
	entre varias opciones. Haz <i>clic</i> en cualquiera de los temas de la derecha para cambiar su configuraci&oacute;n.';
...
$helptxt['xmlnews_enable'] = 'Permite crear un enlace a las <a href="' . $scripturl . '?action=.xml;sa=news">Noticas Recientes</a>
...
$helptxt['globalCookies'] = 'Permite el uso de cookies independientes de subdominio.  Por ejemplo, si...<br />
	Tu sitio est&aacute; en http://www.smallpirate.com/,<br />
	Y tu foro est&aacute; en http://foro.smallpirate.com/,<br />
...
$helptxt['emailmembers'] = 'En este mensaje puedes usar algunas &quot;variables&quot;.  &Eacute;stas son:<br />
	...
	{$latest_member.link} - El enlace al &uacute;ltimo usuario registrado.<br />
...
$helptxt['countChildPosts'] = 'Al marcar esta opci&oacute;n, todos los mensajes y temas de un foro hijo contar&aacute;n en los totales del foro.<br /><br />This will make things notably slower, but means that a parent with no posts in it won\'t show \'0\'.';
...
$helptxt['enableReportPM'] = 'Esta opci&oacute;n permite a tus usuarios informar a los administradores sobre mensajes privados que hayan recibido. Puede ser &uacute;til para controlar cualquier abuso de los mensajes privados.';
	...
	<ul>
		<li>
			...
			<b>Activaci&oacute;n de Usuario</b><br />
				Cuando esta opci&oacute;n esta activada cualquier usuario que se registre en tu foro tendr&aacute; un enlace de activaci&oacute; que se le enviar&aacute; por email que tendr&aacute;n que visitar antes que puedan convertirse usuarios v&aacute;lidos<br />
		</li><li>
...
$helptxt['password_strength'] = 'Esta opci&oacute;n determina el grado de robusted requerida para las contrase&ntlde;as seleccionadas por los usuarios de tu foro. Cuanto m&aacute;s &quot;robusta&quot; sea la contrase&ntilde;a, m&aacute;s dif&iacute;cil es comprometer las cuentas de los usuarios.
	Las posibles opciones son:
	<ul>
		<li><b>Baja:</b> La contrase&ntilde;a debe ser contener al menos cuatro caracteres.</li>
		<li><b>Media:</b> La contrase&ntilde;a debe contener al menos ocho caracteres, y no puede ser parte del nombre o direcci&oacute;n email del usuario.</li>
		<li><b>Alta:</b> Como la Media, excepto que la contrase&ntilde;a debe contener tambi&eacute;n una mezcla de may&uacute;sculas, min&uacute;sculas y al menos un n&uacute;mero.</li>
	</ul>';
...
$helptxt['moderator_why_missing'] = 'Debido a que la moderaci&oacute;n se realiza en cada foro, debes hacer a un usuario moderador desde la <a href="javascript:window.open(\'' . $scripturl . '?action=manageboards\'); self.close();">interface de manejo de foros</a>.';

$helptxt['permissions'] = 'A trav&eacute;s de los permisos les permites o impides a los grupos hacer cosas espec&iacute;ficas.<br /><br />Puedes modificar varios foros al mismo tiempo usando las casillas, o busca en los permisos por un grupo espec&iacute;fico al hacer clic en \'Modificar.\'';
...
$helptxt['permissions_deny'] = 'Denegar permisos puede ser &uacute;til cuando quieres quitar permisos de algunos usuarios. Puedes a&ntilde;adir un grupo con permiso \'denegado\' a los miembros que deseas denegar un permiso.<br /><br />Util&iacute;zalos con cuidado, un permiso denegado prevalece, no importa a que otros grupos pertenezca el usuario.';
$helptxt['permissions_postgroups'] = 'Al activar permisos para grupos basados en el n&uacute;mero de mensajes podr&aacute;s asignar permisos a usuarios que han publicado una cierta cantidad de mensajes. Los permisos de grupos basados en el n&uacute;mero de mensajes se <em>a&ntilde;den</em> a los permisos de los grupos convencionales.';
$helptxt['permissions_by_board'] = 'Al activar esta opci&oacute;n, podr&aacute;s establecer diferentes permisos para cada foro y cada grupo. Por defecto, el foro utiliza permisos globales, pero con esta opci&oacute;n activa, puedes cambiar localmente los permisos de un foro. Proporciona una muy sofisticada manera de gestionar tus permisos.';
$helptxt['membergroup_guests'] = 'El grupo de invitados son todos los usuarios que no est&aacute;n conectados.';
$helptxt['membergroup_regular_members'] = 'Los usuarios regulares son todos aquellos que est&aacute;n conectados, pero que no tienen asignado un grupo primario.';
$helptxt['membergroup_administrator'] = 'El administrador puede, por definici&oacute;n, ver y realizar cualquier cosa en el foro. No se establecen permisos para el administrador.';
...
$helptxt['avatar_allow_server_stored'] = 'Esto le permite a tus usuarios seleccionar avatares almacenados en tu servidor. Est&aacute;n, generalmente, en el mismo lugar que SMF dentro del directorio avatars.<br />Como tip, si creas subdirectorios en ese directorio, puedes hacer &quot;categor&iacute;as&quot; de avatares.';
$helptxt['avatar_allow_external_url'] = 'Con esta opci&oacute;n activada, tus usuarios pueden especificar un URL para sus propios avatares. La desventaja de esto es, en algunos casos, puedan utilizar im&aacute;genes muy grandes o que no desees que utilicen en tu foro.';
...
$helptxt['search'] = 'Aqu&iacute; puedes ajustar la configuraci&oacute;n de la funci&oacute;n de b&uacute;squeda. Es importante mencionar que aqu&iacute; no puedes especificar quien tiene acceso a la funci&oacute;n de b&uacute;squeda. Usa la pantalla de \'manejar permisos\' en el panel administrativo para eso.';
...
$helptxt['ban_cannot_post'] = 'La restricci&oacute;n \'no puede publicar\' establece el modo s&oacute;lo-lectura para el usuario restringido. El usuario no puede crear nuevos temas, ni responder a temas ya existentes, ni enviar mensajes privados ni votar en encuestas. Los usuarios restringidos, sin embargo, pueden leer mensajes privados y temas.<br /><br />Se muestra un mensaje de advertencia a usuarios que tiene restringido el acceso de esta manera.';

$helptxt['posts_and_topics'] = '
	<ul>
		<li>
			<b>Configuraci&oacute;n de Mensajes</b><br />
			Modifica la configuraci&oacute;n relacionada con la publicaci&oacute;n de mensajes y la manera en la que se muestran. Puedes tambi&eacute;n activar la comprobaci&oacute;n ortogr&aacute;fica aqu&iacute;.
		</li><li>
			<b>C&oacute;digos BBC</b><br />
			Activa los c&oacute;digos que se muestran en los mensajes del foro. Tambi&eacute;n se ajusta qu&eacute; c&oacute;digos se permiten y cu&aacute;les no.
		</li><li>
			<b>Palabras Censuradas</b>
			Para controlar el lenguaje de tu foro, puedes censurar ciertas palabras. Esta funci&oacute;n te permite convertir palabras prohibidas en versiones adecuadas.
		</li><li>
			<b>Configuraci&oacute;n de Temas</b>
			Modifica la configuraci&oacute;n relacionada con temas. El n&uacute;mero de temas por p&aacute;gina, d&oacute;nde est&aacute;n activados o no los mensajes pegados, el n&uacute;mero de mensajes necesarios para ser un tema candente, etc.
		</li>
	</ul>';

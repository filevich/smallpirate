...
function template_main()
{
	...
	while ($ban = $context['get_ban']())
	{
		echo '
			<tr>
				<td align="left" valign="top" ><a href="', $boardurl, '?action=profile;user=', $ban['name'], '">', $ban['name'], '</a></td>
				...
				<td align="center" valign="top"><a href="/?action=ban;sa=edit;sort=', $context['sort_by'], $context['sort_direction'] == 'up' ? ';desc' : '',';bg=', $ban['id'], '">', $txt[17], '</a>
				</td>
	...
	echo '	<tr class="citacuerpo">
			...
			<div style="float: right;">Seleccionados: <input class="login" type="submit" name="removeBans" style="font-size: 10px;" value="Eliminar" />
					</div>
				</td>
			</tr>
		</table>

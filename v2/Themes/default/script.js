...
function actualizar_comentarios(){
  ajax_rebote('/comentarios.php', 'GET', '', false, '#last_comments');
}

/* Efecto Ajax Rebote */
function ajax_rebote(url, method, params, cache2, div){
  $(div).slideUp(1);
  $.ajax({
    type: method,
    url: url,
    ...
    success: function(h){
      $(div).html(h);
      $(div).slideDown({duration: 1000, easing: 'easeOutBounce'});
    }
  });
}

function actualizasr_comentarios() {
    $.ajax({
        type: "POST",
        url: "http://yelidmod.com/comentarios.php",
        
        beforeSend: function(objeto){
            $('#last_comments').hide();
            $('#last_comments_reload').hide();
        },                            
        success: function(datos){
            $('#last_comments').html(datos);
            $('#last_comments').fadeIn("slow");
            $('#last_comments_reload').fadeIn("slow");
        }
    });        
}
